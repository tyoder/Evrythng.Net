...
{
    /// <summary>
    /// This interface specifies the methods/behaviors that a Thng Repository must implement.
    /// </summary>
    public interface IThngRepository
    {
        /// <summary>
        /// Creates a new Thng
        /// </summary>
        ...
        /// <summary>
        /// Gets a specific property of a Thng and returns a history of values with timestamps.
        /// </summary>
        /// <param name="thngId">The Id of the Thng</param>
        /// <param name="propertyKey">The property key of the desired property</param>
        /// <returns>A specific Thng Property</returns>
        ...
        /// <summary>
        /// Deletes a specific Property of a Thng, including all values of that Property over time.
        /// </summary>
        /// <param name="thngId">The Id of the Thng</param>
